...
<body>
    ...
    <form action="project_data.php" method="get">
        <fieldset id="sect1">
            ...
            <input type="radio" name="std_year" value="1"><label>ปี 5</label>
        </fieldset>
        ...
        <fieldset id="sect2">
            ...
            <textarea type="textarea" name="prj_name_en" rows="5" style="width:250px;"></textarea>
                ...
                <label for="=prj_type">ประเภทโครงงาน</label><br>
                <select name ="prj_type">
                    <option value="1">เกม</option>
                    <option value="2">โปรเเกรมเดสก์ทอป</option>
                    <option value="3">โปรแกรมมือถือ</option>
                </select>
                <label>เครื่่องมือที่ใช้ในการพัฒนา</label>
                ...
                <select name="prj_advisor">
                     ...
                     <option value="2">ผศ.ทิพย์วรรณ ฟูเฟือง</option>
                </select>
        </fieldset>
